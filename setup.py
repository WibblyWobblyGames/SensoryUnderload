...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "SensoryUnderload.py"
 
        #Name of program
        self.project_name = "SensoryUnderload"
        ...
        #Auhor of program
        self.author_name = "Alex Makepeace"
        self.author_email = "makepeac@ualberta.ca"
    ...
    def run(self):
        ...
        extra_datas = [("", [r"%s/freesansbold.ttf" % PYGAME_DIR,
        ...
        filename = "SensoryUnderload/"
        for trackNumber in range(1,20):
            filename = "SensoryUnderload/InBFlat" + str(trackNumber) + ".ogg"
            abspath = os.path.abspath(filename)
            extra_datas.append(abspath)
